...
//typedef int  (*bh_server_connect_task)(bh_module *module, bh_event *event, bh_server *server, const char *ip, int port, char *type);
...
//bh_connect_task_arg *    bh_connect_task_generator(bh_module *module, bh_event *event, bh_server *server, const char *ip, int port, char *type);
...
bh_close_task_arg *      bh_close_task_generator(bh_module *module, bh_event *event, bh_server *server, int sock_fd);
