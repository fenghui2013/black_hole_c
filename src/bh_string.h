...
int         bh_string_expansion(bh_string *string, int max_size);
int         bh_string_update_start(bh_string *string, int len);
int         bh_string_update_end(bh_string *string, int len);
char *      bh_string_get_start(bh_string *string);
char *      bh_string_get_end(bh_string *string);
